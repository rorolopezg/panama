...
public class ProductRisk   {
  @JsonProperty("productRiskId")
  private String productRiskId = null;
  ...
  public ProductRisk productRiskId(String productRiskId) {
  ...
  @Schema(example = "23423", description = "ID interno generado por el sistema.")
    ...
    public String getProductRiskId() {
    return productRiskId;
  }

  public void setProductRiskId(String productRiskId) {
    this.productRiskId = productRiskId;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.productRiskId, productRisk.productRiskId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(productRiskId, franchiseCurrency, franchiseDimension, franchiseMax, franchiseMin, franchiseType, franchiseValue, limits, riskGroup, riskType);
  }
  ...
  public String toString() {
    ...
    sb.append("    productRiskId: ").append(toIndentedString(productRiskId)).append("\n");
