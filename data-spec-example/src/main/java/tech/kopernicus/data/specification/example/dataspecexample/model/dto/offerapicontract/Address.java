...
public class Address   {
  ...
  public Address urbanization(String urbanization) {
   ...
   * @return urbanization
   **/
  @Schema(description = "Urbanización")
  ...
  public Address neighborhood(Neighborhood neighborhood) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, address.id) &&
        ...
        Objects.equals(this.urbanization, address.urbanization) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, address, addressType, apartment, blockNo, email, invoiceYN, mailYN, notes, phone, primaryFlag, quarterName, streetName, streetNo, urbanization, zipCode, city, country, neighborhood, region, state);
  }
