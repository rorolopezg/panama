...
public class ProductTax   {
  @JsonProperty("premtaxId")
  private Long premtaxId = null;
  ...
  public ProductTax premtaxId(Long premtaxId) {
    this.premtaxId = premtaxId;
    return this;
  }
  ...
  @Schema(example = "23423", description = "ID interno generado por el sistema.")
    ...
    public Long getPremtaxId() {
    return premtaxId;
  }

  public void setPremtaxId(Long premtaxId) {
    this.premtaxId = premtaxId;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.premtaxId, productTax.premtaxId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(premtaxId, applied, calcRule, currency, efectiveFrom, efectiveTo, fractRule, included, manualTaxRate, orderNo, taxAmount, taxRate, taxType, whRule);
  }
  ...
  public String toString() {
    ...
    sb.append("    premtaxId: ").append(toIndentedString(premtaxId)).append("\n");
